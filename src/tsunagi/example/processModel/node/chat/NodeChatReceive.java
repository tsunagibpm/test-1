...
public class NodeChatReceive extends NodeUserInputTask {
	public NodeChatReceive() {
		this.setName("NodeChatReceive");
		this.setDescription("Chat Reseiver");
	...
	protected void setPageInfoForOpenTask(PageInfo pageInfo) {
		pageInfo.setPageName("chatReceive.jsp");
	}
